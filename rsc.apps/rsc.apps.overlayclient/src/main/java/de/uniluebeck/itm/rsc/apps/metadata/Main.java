...
public class Main {
	...
	public static void main(final String[] args) throws IOException {
		...
		options.addOption("capabilities", true,
		...
		if (args.length == 0) {
			...
			if (cmd != null) {
				...
				if (cmd.hasOption("help")) {
					...
					String microcontroller = cmd
							.getOptionValue("microcontroller");
					...
					if (validInput) {
						...
						// the paramteter 'capabilites' holds the capabilites in
						// the
	...
	public static void printHelp(final Options options) {
		...
		System.out
				.println("Search by id of the node: -id 123 -server 141.48.65.111 "
						+ "-serverPort 8080");
		System.out.println("Search by the microcontroller of the node: "
		...
		System.out
				.println("Search by IP-Address of the node: -searchIP 141.49.65.111"
						+ " -server 141.48.65.111 -serverPort 8080");
		System.out.println("Search by IP-Address and description of the node: "
