package de.uniluebeck.itm.rsc.remote.server;
...
import de.uniluebeck.itm.rsc.remote.files.MessageServiceFiles.Identification;
...
import de.uniluebeck.itm.rsc.remote.server.operations.EraseFlashOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.GetChipTypeOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.ProgramOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.ReadFlashOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.ReadMacOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.ResetOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.SendOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.WriteFlashOperation;
import de.uniluebeck.itm.rsc.remote.server.operations.WriteMacOperation;
import de.uniluebeck.itm.rsc.remote.server.utils.ClientID;
import de.uniluebeck.itm.rsc.remote.server.utils.RemoteMessageListener;
import de.uniluebeck.itm.rsc.remote.server.utils.ServerDevice;
...
//				}
	...
	static class OperationsImpl implements Operations.Interface {
		 ...
		 * 
		 * @param controller
		 *            the RpcController for this operation
		 * @param request
		 *            the OpKey-request from the Client
		 * @param done
		 *            RpcCallback
		 */
		@Override
		 ...
		 *            the RpcController for this operation
		 * @param request
		 *            the ProgramPacket-request from the Client
		 * @param done
		 *            RpcCallback
		 */
		@Override
		 ...
		 *            the RpcController for this operation
		 * @param request
		 *            the MacData-request from the Client
		 * @param done
		 *            RpcCallback
		 */
		@Override
		 ...
		 *            the RpcController for this operation
		 * @param request
		 *            the FlashData-request from the Client
		 * @param done
		 *            RpcCallback
		 */
		@Override
		 ...
		 *            the RpcController for this operation
		 * @param request
		 *            the Timeout-request from the Client
		 * @param done
		 *            RpcCallback
		 */
		@Override
		 ...
		 *            the RpcController for this operation
		 * @param request
		 *            the sendData-request from the Client
		 * @param done
		 *            RpcCallback
		 */
		@Override
	...
	static class PacketServiceImpl implements PacketService.Interface {
		 ...
		 *            the RpcController for this operation
		 * @param request
		 *            the PacketTypeData-request from the Client
		 * @param done
		 *            RpcCallback
		 */
		@Override
