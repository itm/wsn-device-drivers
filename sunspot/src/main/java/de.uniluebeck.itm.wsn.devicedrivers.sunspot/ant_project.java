...
//
        ...
        boolean inspecOutput = true;
            String msg="";
             while(inspecOutput)
             {
                out_msg=out.toString();
                 msg=out.toString();
                 List<String> msgs=getMessages(out.toString());
                 out.reset();
    ...
    public List<String>  getMessages(String txt){
        ...
        for(String str:msgs){
            ...
            if (parts[0] !=null && parts[0].contains("SunspotHostMsg") ){
                answer.add(parts[2]+":"+parts[1]);
            }
