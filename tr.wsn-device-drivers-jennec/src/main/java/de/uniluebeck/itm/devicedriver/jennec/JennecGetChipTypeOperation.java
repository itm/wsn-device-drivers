...
public class JennecGetChipTypeOperation extends AbstractGetChipTypeOperation {

	/**
	 * Logger for this class.
	 */
	private static final Logger log = LoggerFactory.getLogger(JennecGetChipTypeOperation.class);
	
	private final JennecDevice device;
	
	public JennecGetChipTypeOperation(JennecDevice device) {
		this.device = device;
	}
