...
public class eraseOperation extends AbstractOperation<Void> {
	...
	public eraseOperation(RpcController controller, RpcCallback<EmptyAnswer> done, Subject user, ClientID id, Timeout request) {
	...
	protected void operate() {
		...
		OperationHandle <Void> handle = deviceAsync.eraseFlash(request.getTimeout(), getAsyncAdapter());
