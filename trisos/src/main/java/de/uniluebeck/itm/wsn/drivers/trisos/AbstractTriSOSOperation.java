 ...
 */
public abstract class AbstractTriSOSOperation<T> implements OperationRunnable<T> {
	 ...
	 */
	public AbstractTriSOSOperation() {
	 ...
	 */
	public AbstractTriSOSOperation(final int sleep, final int steps) {
		this.sleep = sleep;
		this.steps = steps;
